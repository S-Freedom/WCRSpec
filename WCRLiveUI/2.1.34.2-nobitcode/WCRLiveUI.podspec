Pod::Spec.new do |s| 
  ...
  s.platform = :ios, "9.0" 
  s.source = {:http => "https://cloudclass-static.oss-cn-beijing.aliyuncs.com/static/zby-sdk/zby-ios-sdk/WCRLiveUI/2.1.34.2-nobitcode/frameworks.zip" } 
